...
MLI_layers = [ 10] #[ 10., 20., 25., 35., 45., 65.]
layer_densities = [ 16.] #[16., 40.]

heat_fluxes_ESATAN = 'Absorbed_Fluxes'# 'Absorbed_Fluxes' or 'Direct_Fluxes'
Radiative_model_import = r'C:\Users\hp\Desktop\University\DSE\DSE-07\boil-off_tool\BO_tool_package\Radiative_model_GEO_single.npz' #put name of Radiative model from ESATAN to be used

press_mode = 'Autogenous' # 'HeliumPress' or 'Autogenous'

VD_MLI_activity = 'False' # 'TRUE' or 'FALSE'. If TRUE, set VDMLI data below

VCS_activity = 'False' # 'TRUE' or 'FALSE'
...
propellant_mass = 30000  # kg
fill_level_initial = 0.9
initial_pressure = 1.3*1e5 # Pa 
p_max = 3*1e5 # Pa
maximum_tank_radius = 3.5 # m
...
tank_heads = 'ellipse' #alternative is 'ellipse'
cap_height = 0.25*maximum_tank_radius # only applicable for 'ellipse' tank head, cap_height should be always less than tank radius!!! (oblate spheroid)
sphere_parts_tank = 4.
...
# MLI properties
layer_specific_weight = 48 #kg/m2 Double aluminized Mylar
spacer_specific_weight = 48 #kg/m2 Dacron net spacers
layer_nom_thickness = 0.3*10**-3 #m
spacer_nom_thickness =  0.3*10**-3#m 

k_MLI = 16 #W/mK
Cp_MLI = 500 #J/kgK. Mylar (DAM Cp) 

emissivity_MLI = 0.2 #inner, from Thermal Control handbook
...
Cp_wall =  500 # Titanium: 526.3 Aluminum 2195-T8: 900. Stainless Steel:500
k_wall =   16.3# Titanium: 6.7 Aluminum 2195-T8: 130.Stainless Steel:16.3
density_wall =  8000 # Titanium: 4430. Aluminum 2195-T8: 3000. Stainless Steel:8000

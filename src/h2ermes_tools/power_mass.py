...
def power_plant_mass(average_power: float, mission_length_days: float, safety_factor: float) -> tuple[float, float, float]:
    """
    ...
    Returns:
            Mass of the fuel cells and reactants in a tuple
    """

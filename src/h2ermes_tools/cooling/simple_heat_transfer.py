...
from h2ermes_tools.cooling.material import SS14404
...
if __name__ == "__main__":
    ...
    density = SS14404.density  # [kg/m³]
    specific_heat = SS14404.specific_heat  # [J/(kg·K)]
    thermal_conductivity = 25  # [W/(m·K)], assumed constant for simplicity
    ...
    # Radiation
    emissivity = 0.9  # assumed constant for simplicity

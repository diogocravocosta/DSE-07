...
class TestExponentialAtmosphere:
    ...
    def make_test_atmosphere(self):
        atmosphere = atm.ExponentialAtmosphere.__new__(atm.ExponentialAtmosphere)
        ...
        atmosphere.altitude = self.height * 1000
    ...
    def test_atmosphere_init(self):
        ...
        test_atmosphere = atm.ExponentialAtmosphere(self.height)
    ...
    def test_exponential_atmosphere(self):
        atmosphere = self.make_test_atmosphere()
        atmosphere.T_exp, atmosphere.scale_height, atmosphere.beta, atmosphere.speed_of_sound = atmosphere.atmosphere(scale_height=7050)
        ...
        atmosphere.rho_exp = atmosphere.density()
